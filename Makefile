# This Makefile is for the YAPC::Europe::UGR extension to perl.
#
...
INST_LIBDIR      = $(INST_LIB)/YAPC/Europe
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/YAPC/Europe
...
DISTNAME = YAPC-Europe-UGR
DISTVNAME = YAPC-Europe-UGR-0.0.3
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: YAPC-Europe-UGR' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "YAPC-Europe-UGR",' >> META_new.json
