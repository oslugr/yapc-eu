...
There are many more options to Málaga, but then you have to take a bus
							     or train
							     to the
							     bus
							     station
...
The ETSIIT can sponsor a single coffee break. Coffee breaks, however,
    ...
    ETSIIT which can give unexpensive and local fare such as garlic olive-oil
...
No. The speaker will have to privide that.
...
As indicated in the main proposal, the university cafeteria +
    dining room is able to accomodate 300 people
    simultaneously. Around the ETSIIT, you can eat at a bar just off
    the tapas (2€ soda or beer + warm dish) or sandwiches or single
    combined plate for 3-4€. There's also a pizza parlor 500 meters
