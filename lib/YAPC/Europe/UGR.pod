...
sponsors, and past events have gathered around 6000EUR just from local
...
This will be compensated with the surplus provided by late arrivals
and sponsors. 

The budget will be adjusted mainly by providing less or more lunches
or adding a coffee break.
...
single speaker. We would need as few as 75 attendees to cover the 75 speakers.
...
While we haven't been asked this by the organization, 
