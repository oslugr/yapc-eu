...
It's going to be, AFAIK, the YAPC::EU southernmost conference, so this fact will have to be taken into account in the details of the conference... not. 
...
We are talking of a ballpark of 10K E<euro>. We will also apply to local
...
Final fees have to be announced. We will request any amount from sponsors, and past events have
							      gathered
							      around
							      6000EUR
							      just
...
This is around 75EUR per attendee, fully covered by early-bird fee and
							      with a
							      deficit
							      for
							      speakers
...
The budget will be adjusted mainly by providing less or more
							      lunches
							      or
							      adding a
							      coffee
...
If we add the cost of one or two invited speakers at around 2000EUR
							      per
							      speaker,
							      there is
							      a
...
Granada has an international airport, but easiest way is to transfer
							     at Madrid
							     or
							     Barcelona.
...
There are many more options to Malaga, which is a big airport, including low-cost flights, but then you have to take a bus or train
							     to the
							     bus
							     station
							     and
...
The local bus company provides also a direct bus to Granada from
							     Madrid
							     airport,
							     with two
							     frequencies
...
=item Malaga Bus Station-Granada, every hour on the hour (roughly,some
							      exceptions)
							      until
21:30. There are buses and trains from the airport to the bus station.

=item Madrid (Estacion Sur) - Granada : 5 horas (ALSA), several buses
							      a day,
							      roughly
							      every
							      hour;
...
=item Barcelona - Granada: 12h, 56 E<euro>, really a long trip in
							      wagon-lit,
							      but an
							      inexpensive
							      option. Barcelona
...
There are buses also from Granada airport to the city center, costing
							      3E<euro>;
							      taxis
							      are
							      roughly
...
Organized or self-organized options are available all year round. The
							      beach is
							      70 kms
							      and a
							      bus run
...
While we haven't been asked this by the organization, they were made
							      to other
							      proposers,
							      so here
							      are the
