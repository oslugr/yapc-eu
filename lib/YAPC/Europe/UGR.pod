...
=head3 How accessible are the venues to people in wheelchairs, people with hearing difficulties,
etc?
...
=head3 If lunch is not provided, please describe the possibilities for attendees to go out and find
