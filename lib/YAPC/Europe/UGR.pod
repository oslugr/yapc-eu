...
Granada is a student city which has been the preferred destination of
Erasmus students for a long time, and that accounts for something. 
It's a lively city with many services for visitors.

=head3 Getting here

Granada has an international airport, but easiest way is to transfer at Madrid or Barcelona.
