...
(Spain). Granada includes such beauties as the Alhambra, the Albaycín quarter, natural park of Sierra Nevada, and the most
beautiful grafittis of all the country. Moreover, the beach is just 70 kilometers (35 minutes by highway) far from the city.
